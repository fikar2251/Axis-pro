                    ...
                    <form action="{{ route('invoice.storeInterim') }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">Date Invoice</label>
                                    <input type="text" autocomplete="on" placeholder="dd/mm/yyyy" id="startdate" class="form-control startdate" name="date_invoice">
                                </div>
                            </div>
...
<script>
    ...
    const OnSelectInterim = async function(q) {
        try {
            ...
            let persen = (parseInt(data.expense) + prof) * 11 / 100
    ...
    const OnSelect = async function(q) {
        ...
        try {
            ...
            let persen = parseInt(sub_total) * 11 / 100
