                        ...
                        <table width="200" border="1" class="table table-bordered hurufkecil table-striped" style="font-size: 12px;">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        {{ $caseList->currency }} {{ is_numeric($caseList->claim_estimate) ? number_format($caseList->claim_estimate, 0, ',','.') : 0 }}
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table width="200" border="0" class="table table-striped">
                                <tbody>
                                    ...
                                    <form action="{{ route('expense.store') }}" method="post">
                                        ...
                                        <tr>
                                            <td>
                                                <input type="number" name="qty" id="qty" step="0.01" class="form-control" placeholder="Qty">
